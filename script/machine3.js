...
let forGymDesktopPictures = {
    desktop: [
        'img/ПК/Силовые рамы/Силовые рамы 2.png',
        'img/ПК/Силовые рамы/Силовые рамы 3.png',
        'img/ПК/Силовые рамы/Силовые рамы.png',
        'img/ПК/Силовые рамы/Силовые рамы.png',
        'img/ПК/Силовые рамы/Силовые рамы.png',
    ...
    laptop: [
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-1.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-2.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-3.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-4.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-5.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-6.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-7.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-8.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-9.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-10.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры-11.png',
        'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png'
    ],

    mobile: [
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-1.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-2.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-3.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-4.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-5.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-6.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-7.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-8.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-9.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-10.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры-11.png',
        'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png'
    ],
};
...
function forPicturesChange() {
    if (window.innerWidth <= 1200) {
        ...
        gymPicture.src = 'img/Мобильная версия/Силовые рамы/Грузоблочные тренажеры.png';
        ...
        gymPicture.src = 'img/Планшет/Силовые рамы/Грузоблочные тренажеры.png';
    } else {
        mainLInfoText.textContent = 'Наведите курсор на маркер на изображении для показа описания';
        ...
        gymPicture.src = 'img/ПК/Силовые рамы/Силовые рамы.png';
    }
}
