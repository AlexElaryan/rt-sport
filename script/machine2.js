let obj = {
    first: ['Горячекатанный профиль с толщиной стенки 3 мм – рамы тренажеров выдерживают заявленную производителем нагрузку', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 2.png'],
    second: ['Все узлы вращения и качения на закрытых подшипниках российского производства', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 3.png'],
    third: ['Возможность регулировки под рост спортсмена - фиксация на пружинных фиксаторах ', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 4.png'],
    forth: ['Чехлы из качественного заменителя кожи российского производства – цвет мягких элементов можно выбрать ', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 5.png'],
    fifth: ['Полимерно-порошковое покрытие рам с возможностью персонализации цвета – цвет рамы тренажера можно выбрать', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png'],
    sixth: ['Все сварные соединения выполнены «вкруг» - гарантия на раму тренажера – 10 лет', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png'],
    seventh: ['Промокод на скидку – ПРОМОКОД', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png'],
    eight: ['Резиновые рукояти на местах хватов ', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 6.png'],
    nineth: ['Качественная пластиковая фурнитура российского производства', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png'],
    ten: ['Тренажеры на свободном весе произведены и сертифицированы по ГОСТ-Р', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png'],
    eleven: ['Адаптеры для хранения дисков нужного диаметра – на ваш выбор 25, 30 или 50 мм', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 7.png'],
    tuelve: ['Для задания нагрузки используются стандартные диски – на ваш выбор 25, 30 или 50 мм', 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png'],
};
...
let forGymDesktopPictures = {
    desktop: [
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 2.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 3.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 4.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 5.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 6.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры 7.png',
        'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png'],
...
function forPicturesChange() {
    if (window.innerWidth <= 1200) {
        ...
        gymPicture.src = 'img/ПК/Тренажеры на свободном весе/Грузоблочные тренажеры.png';
    }
}
